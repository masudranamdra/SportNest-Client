...
export default function RegisterPage() {
  ...
  return (
    <div className="flex-grow flex flex-col justify-center items-center py-20 px-4 bg-slate-50 dark:bg-[#070b19] transition-colors duration-200 relative min-h-screen">
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/60 rounded-3xl overflow-hidden shadow-sm dark:shadow-2xl p-8 space-y-6 relative z-10 backdrop-blur-md">
        ...
        <div className="text-center space-y-3">
          ...
          <h2 className="text-xl font-extrabold text-slate-900 dark:text-slate-100">Create Player Profile</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block">
              Profile Photo URL <span className="text-[9px] text-slate-400 dark:text-slate-500 lowercase font-medium">(Optional)</span>
            </label>
            <div className="relative">

  ...
  return (
    <div className="flex-grow flex flex-col justify-center items-center py-20 px-4 text-center bg-slate-50 dark:bg-slate-950">
      ...
      <div className="mt-8 flex gap-4">
        <button
          onClick={() => reset()}
          className="flex items-center bg-primary-500 hover:bg-primary-600 text-white px-6 py-2.5 rounded-xl font-semibold shadow-md active:scale-95 transition-all"
        >
